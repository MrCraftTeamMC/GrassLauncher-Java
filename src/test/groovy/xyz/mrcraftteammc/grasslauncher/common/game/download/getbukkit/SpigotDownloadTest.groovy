...
class SpigotDownloadTest {
    private final String url_modern = "https://download.getbukkit.org/spigot/spigot-1.20.2.jar" // >=1.17
    private final String url_legacy = "https://cdn.getbukkit.org/spigot/spigot-1.16.5.jar" // <=1.16.5
    ...
    private final String filename = "spigot.jar"
